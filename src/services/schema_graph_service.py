    ...
    def build_graph(self, enable_profiling: bool = True):
            ...
            for col in columns:
                ...
                if profile_data and table in profile_data.get("tables", {}):
                    ...
                    if "error" not in table_profile:
                        ...
                        col_stats = table_profile.get("column_statistics", {}).get(col_name, {})
                        if col_stats:
                            col_props.update(col_stats)
                        
                        # Add LLM-generated descriptions
                        col_desc = table_profile.get("column_descriptions", {}).get(col_name, {})
                        if col_desc:
                ...
                self.graph.add_edge(col_id, table, condition="association")
        ...
        for view in views:
            ...
            for col in columns:
                ...
                self.graph.add_edge(col_id, view, condition="association")
            ...
            for col in columns:
                if col.get('Key') == 'MUL':
                    ...
                    try:
                        ...
                        print(f"  Warning: Could not retrieve FK info for {table}.{col['Field']}: {e}")
