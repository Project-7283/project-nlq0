-- ==========================================
-- PART 3: SEPTEMBER-DECEMBER ORDERS + ORDER ITEMS
-- Execute AFTER Part 1 and Part 2
-- ==========================================
-- ORDERS: 240 orders spanning 6 months (July-December 2024)
-- Format: (order_id, user_id, order_number, order_date, total_amount, discount, tax, shipping, final_amount, payment_method, payment_status, order_status, address_id, est_delivery, actual_delivery)
